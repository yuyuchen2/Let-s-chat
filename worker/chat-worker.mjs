...
export default {
  async fetch(request, env) {
    ...
    if (request.method === 'OPTIONS') {
      ...
      if (origin && origin !== 'https://chat1.yyc2.dpdns.org') return new Response(JSON.stringify({ error: 'Origin not allowed' }), { status: 403, headers })
      headers['Access-Control-Allow-Origin'] = origin || 'https://chat1.yyc2.dpdns.org'
      headers['Access-Control-Allow-Credentials'] = 'true'
